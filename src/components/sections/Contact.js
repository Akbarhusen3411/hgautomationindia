      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          <ScrollReveal animation="fade-down" duration={600}>
            <span className="inline-block px-4 py-2 bg-accent/20 text-accent rounded-full text-sm font-medium mb-4 border border-accent/20">
              Contact Us
            </span>
          </ScrollReveal>
        ...
        <div className="grid lg:grid-cols-5 gap-4 sm:gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
              ...
              <StaggerContainer animation="fade-up" staggerDelay={100} className="space-y-2">
                {contactInfo.map((item, index) => (
                  <div key={index} className="group relative">
                    <div className="flex items-center gap-2.5 p-2.5 rounded-lg bg-slate-800/60 border border-slate-700/30
                                  hover:bg-slate-800/80 hover:border-accent/40 transition-colors duration-300
                      ...
                      <div className="flex-1 min-w-0">
                        <span className="text-xs text-accent uppercase tracking-wider font-semibold block leading-tight">
                          {item.label}
                        </span>
                        {item.href ? (
            ...
            <ScrollReveal animation="fade-up" delay={500} duration={700}>
              <div className="mt-3 p-3 rounded-lg bg-slate-800/60 border border-slate-700/30">
                <h4 className="text-white font-medium text-sm mb-2">Quick Connect</h4>
                <div className="flex gap-2">
                  <a href="https://wa.me/918320049749" target="_blank" rel="noopener noreferrer"
                     className="flex-1 flex items-center justify-center gap-1.5 py-2 px-2.5 bg-green-500/10 border border-green-500/30
                              text-green-400 text-sm rounded-md transition-all duration-300 hover:scale-105
                  ...
                  <a href="tel:+918320049749"
                     className="flex-1 flex items-center justify-center gap-1.5 py-2 px-2.5 bg-accent/10 border border-accent/30
                              text-accent text-sm rounded-md transition-all duration-300 hover:scale-105
