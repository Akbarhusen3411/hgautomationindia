...
(function() {
    ...
    const mobileMenuToggle = document.getElementById('mobile-menu-btn') || document.querySelector('.mobile-menu-toggle');
    const mobileMenu = document.getElementById('mobile-menu');
    const navLinks = document.querySelectorAll('.nav-item, .nav-link, .mobile-nav-item, .mobile-nav-link');
    ...
    function init() {
        ...
        if (mobileMenu) {
            const menuBg = mobileMenu.querySelector('.mobile-menu-bg');
            if (menuBg) {
                menuBg.addEventListener('click', closeMobileMenu);
            }
            // Also close on overlay itself if it has the class
