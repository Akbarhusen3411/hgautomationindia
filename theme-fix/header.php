        ...
        <a href="<?php echo esc_url(home_url('/')); ?>" class="header-logo-link">
            <div class="header-logo-container">
                ...
                <?php if (has_custom_logo()): ?>
                    <?php the_custom_logo(); ?>
                <?php else: ?>
                    <div class="logo-svg-fallback">
                        <svg viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M30 5L52.5 17.5V42.5L30 55L7.5 42.5V17.5L30 5Z" fill="url(#logoGrad)" stroke="#2da0d4" stroke-width="2"/>
                            <text x="30" y="38" text-anchor="middle" fill="white" font-size="16" font-weight="bold">HG</text>
                            <defs>
